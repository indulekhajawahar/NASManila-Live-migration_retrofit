...
public class PreferenceManager implements NaisTabConstants {
    ...
    public static void  setparentEssentials(ArrayList<ParentListModel> list, Context context){
        SharedPreferences prefs = context.getSharedPreferences(SHARED_PREF_NAS,
                Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs.edit();
        Gson gson = new Gson();
    ...
    public static ArrayList<ParentListModel> getparentEssentials(Context context){
        SharedPreferences prefs = context.getSharedPreferences(SHARED_PREF_NAS,
                Context.MODE_PRIVATE);
        Gson gson = new Gson();
        String json = prefs.getString("parenetssentials", null);
        Type type = new TypeToken<ArrayList<ParentListModel>>() {}.getType();
