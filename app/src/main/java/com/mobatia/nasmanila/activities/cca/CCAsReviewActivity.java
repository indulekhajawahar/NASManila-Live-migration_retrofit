...
public class CCAsReviewActivity extends Activity implements URLConstants, JSONConstants {
    ...
    private void ccaSubmitAPI() {
        ...
        paramObject.addProperty("cca_details", cca_details);
        paramObject.addProperty("users_id", PreferenceManager.getUserId(mContext));
        Call<CcaSubmitResponseModel> call = service.cca_submit("Bearer "+PreferenceManager.getAccessToken(mContext),paramObject);
