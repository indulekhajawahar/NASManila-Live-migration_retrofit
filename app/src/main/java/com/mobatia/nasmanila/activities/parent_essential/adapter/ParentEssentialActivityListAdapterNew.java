...
public class ParentEssentialActivityListAdapterNew extends RecyclerView.Adapter<ParentEssentialActivityListAdapterNew.MyViewHolder> {
    ...
    private ArrayList<ParentListModel> mnNewsLetterModelArrayList;
    String dept;
    ...
    public ParentEssentialActivityListAdapterNew(Context mContext, ArrayList<ParentListModel> mnNewsLetterModelArrayList) {
